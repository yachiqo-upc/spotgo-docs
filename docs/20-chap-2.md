...
- **Parking Administrator (Administrador de estacionamiento):** Usuario cuya cuenta es creada o habilitada por un SuperAdmin y que se encarga de gestionar la configuración, supervisión y organización de las zonas y usuarios del estacionamiento.
...
- **SuperAdmin (Administrador de plataforma):** Usuario encargado de registrar *Tenants*, crear o habilitar las cuentas iniciales de los *Parking Administrators*, administrar configuraciones de clientes B2B y consultar la facturación asociada al servicio de SpotGo.
